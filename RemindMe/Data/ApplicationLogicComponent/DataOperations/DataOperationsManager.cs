    ...
    public class DataOperationsManager
    {
        ...
        #region Methods
            ...
            private void Init()
            {
                ...
                this.ReminderMethods = new ReminderMethods(this.DataManager);
            }
            #endregion
        ...
        #region Properties
            ...
            #region ReminderMethods
            public ReminderMethods ReminderMethods
            {
                get { return reminderMethods; }
                set { reminderMethods = value; }
            }
            #endregion
